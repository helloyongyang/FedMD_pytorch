...
load_path = ["./save/Pretrain_client_0_epoch_30.pkl", "./save/Pretrain_client_1_epoch_30.pkl"]
for n, net in enumerate(clinet_nets):
    net.to(device)
    net.load_state_dict(torch.load(load_path[n]))
    print("loaded para model " + str(n))
